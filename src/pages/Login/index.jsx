...
export default function Login () {
    ...
    return (
        <div className="flex flex-col justify-center items-center w-screen h-screen relative">
            {ctx.state.logginIn &&  <div className="absolute"><Loader/></div>}
            ...
            <div className="flex flex-col bg-baseColor w-[300px] h-[320px] border-2 border-baseBlue p-3 items-center rounded-[20px]">
                ...
                <div className="flex flex-col mx-2 items-center">
                    <button className={css.loginButton} onClick={login}>Нэвтрэх</button>
                    ...
                    <button className=" text-sm font-300 text-red-500 hover:text-red-400 w-[200px] h-[40px] ">Нууц үг сэргээх</button>
                ...
                <button className={css.signupButton} onClick={signup}> Бүртгүүлэх</button>
            </div>
