...
const Grammar = (props) => {
    ...
    <div className="pt-6 pb-96 m-auto md:w-[80%] lg:w-[60%] text-baseBlack">
        ...
        <div className="flex mb-10">
            <button className="w-[150px] p-3 bg-blue-400 rounded-xl text-white hover:bg-blue-500 flex justify-center items-center m-auto" onClick={showConfirm}>Save</button> 
        </div>
    </div>
