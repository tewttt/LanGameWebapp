    ...
    return ( 
        <div className="flex flex-col justify-center items-center text-gray-700 max-w-[1540px] mx-auto">
            ...
            <div className="flex flex-col bg-baseColor w-[300px] h-[320px] border-2 border-baseBlue p-3 items-center rounded-[20px]">>
                ...
                <div className="flex flex-row justify-between items-center mr-[-5px]">
                ...
                <button variant="outlined"  className="btn p-2 bg-baseBlue  w-[200px] h-[40px] text-base active:bg-red-200 hover:bg-blue-500 items-center" onClick={login}>Нэвтрэх</button>
            </div>
        </div>
)}
