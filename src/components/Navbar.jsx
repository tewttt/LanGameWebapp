    ...
    return (
        ...
        >
            ...
            <div 
                ...
                className={
                props.showSidebar ? 
                "overflow-y-hidden  left-0 top-0 z-10 ease-in duration-300 absolute h-screen w-[50%] bg-[#383030]"
                : "absolute top-0 h-screen left-[-100%] ease-in duration-500"}
            >
                <ul className=" pt-12 flex flex-col items-center justify-center text-white">
                    <li onClick={()=> history.push("/user")} className="w-[200px] h-[30px] flex items-center justify-center border border-gray-400 hover:border-blue-500 bg-[#383030]">
                        <a href="/user">Profile</a>
                    </li>
                  
                    <li onClick={()=> history.push("/logout")} className="w-[200px] h-[30px] flex items-center justify-center border border-gray-400 hover:border-blue-500 bg-[#383030]">
                        <a href="/logout">Гарах</a>
                    </li>
                </ul>
            </div>
