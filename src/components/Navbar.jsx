        ...
        >
            ...
            >
                <ul className=" pt-12 flex flex-col items-center justify-center text-white">
                    ...
                    <li onClick={()=> history.push("/addLesson")} className="m-2 p-1 rounded-lg w-[100px] h-[20px] md:w-[200px] md:h-[30px] flex items-center justify-center border border-gray-400 hover:border-blue-500 hover:text-blue-500 bg-[#383030]">
                        <a href="/addLesson">Хичээл</a>
                    </li>
                  
                    <li onClick={()=> history.push("/logout")} className="m-2 p-1 rounded-lg w-[100px] h-[20px] md:w-[200px] md:h-[30px] flex items-center justify-center border border-gray-400 hover:border-blue-500 hover:text-blue-500 bg-[#383030]">
                        <a href="/logout">Гарах</a>
                    </li>
                </ul>
            </div>
