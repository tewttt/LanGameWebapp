...
const Lesson = props => {
    ...
    return (
        <div>
         {status === "Төлбөргүй" ? (
            <div className="flex flex-col py-3 items-center border border-blue-500 w-[200px] hover:scale-105 hover:border-blue-300 h-[200px] rounded-[5px] lg:w-[250px] lg:h-[250px]" >  
            ...
            <div className="flex flex-col py-3 items-center border border-blue-500 w-[200px] h-[200px] hover:scale-105 hover:border-blue-300 rounded-[5px] lg:w-[250px] lg:h-[250px]" >  
                <div className="flex mb-2"> 
                    <div className="mx-3"> {props.lesson.state.base.language}</div> 
                    <div className="mx-3">№{props.lesson.state.base.lessonNumber}</div> 
                    <div className="mx-3">{props.lesson.state.base.level}</div>  
